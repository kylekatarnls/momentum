(function (root, factory) {
    ...
    Momentum.prototype.getItem = function (collection, id, callback) {
        ...
        return this.findOne([collection, {_id: id}], function (element) {
            var collection = new Collection(this, collection, [element]);
            callback(element && collection[0]);
        }.bind(this));
    };
    ...
    function Collection(momentum, name, data) {
        ...
        arrayPrototype.push.apply(this, (data || []).map(function (properties) {
            return properties && new Item(this, {_id: properties._id}, properties);
        }.bind(this)));
        this._stop = momentum.on(function (events) {
            events.forEach(function (event) {
                if (event.listen.collection === name && !event.listen.filter && !event.listen.id) {
    ...
    Collection.prototype.stop = function () {
        this._stop();
        this.momentum.stopListenCollection(this.name);
    };
    ...
    Item.prototype.onChange = function (callback) {
        return this.collection.onChange(function (events) {
            callback(events);
        });
    };
    ...
    Item.prototype.update = function (properties, callback) {
        this.collection.updateOne(this.identity, {$set: properties}, callback);
